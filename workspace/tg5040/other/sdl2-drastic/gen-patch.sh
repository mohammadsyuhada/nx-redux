...
WORK_DIR="/Users/mohammadsyuhada/Work/Personal/NextUI-Redux/workspace/tg5040/other/sdl2-drastic"
SDL_DIR="$WORK_DIR/SDL_drastic"
TMPDIR="/tmp/sdl2-drastic-baseline"
PATCH_0006="$WORK_DIR/0006-add-hook-for-drastic.patch"
OUTPUT="$WORK_DIR/fix-tg5040.patch"
